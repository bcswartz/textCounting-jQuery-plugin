 ...
 * by Brian Swartzfager (http://www.thoughtdelimited.org/thoughts/demos/textCounting/)
 * 
 * 
 * 
 ...
 * 
 * 1.  The <textarea> must have an "id" attribute with a unique value and a "maxTextLength" attribute with an integer denoting
 * the character limit.
 * 
 ...
 * 
 * Because the element ids and the maxTextLength value is specific to each <textarea>, you can use a single call of the 
 ...
 * ....
 * 
 * <textarea id="justification" maxTextLength="2000" rows="4" cols="60"></textarea>
 ...
 * 
 * The maxLengthSource setting denotes where the plugin looks for the limit value (the "max length") for each <textarea>.
 ...
 * of maxLengthAttribute within the <textarea> element itself.  When the maxLengthSource setting is set to "metadata", 
 * the plugin will look for the attribute denoted in the value of maxLengthAttribute within the metadata defined in the "class"
...
(function($) {
	...
	$.fn.textCounting.defaults = {
		   ...
		   maxLengthList: "", 
		   maxLengthAttribute: "maxTextLength", 
