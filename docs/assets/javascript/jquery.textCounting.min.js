...
{var currentDirection=directionArray[setting];var textCount=$.fn.textCounting.calculateCount($box,options.countWhat,currentDirection,maxCount);var currentTarget=targetArray[setting];$.fn.textCounting.displayResult($box,options.targetModifierType,currentTarget,textCount,maxCount,currentDirection,options.lengthExceededClass);}});}});};$.fn.textCounting.defaults={maxLengthSource:"attribute",maxLengthList:"",maxLengthAttribute:"maxTextLength",countWhat:"characters",countDirection:"down",targetModifierType:"suffix",targetModifier:"Down",lengthExceededClass:"",excludeIds:""};$.fn.textCounting.calculateCount=function(obj,countWhat,direction,maxCount){if(countWhat=="characters")
{if(direction=="down")
